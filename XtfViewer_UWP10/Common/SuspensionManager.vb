    ...
    Friend NotInheritable Class SuspensionManager
        ...
        Public Shared Async Function RestoreAsync(Optional sessionBaseKey As String = Nothing) As Task
            ...
            Try
                ...
                For Each weakFrameReference As WeakReference(Of Frame) In _registeredFrames
                    Dim frame As Frame = Nothing
                    If weakFrameReference.TryGetTarget(frame) AndAlso DirectCast(frame.GetValue(FrameSessionBaseKeyProperty), String) Is sessionBaseKey Then
        ...
        Private Shared FrameSessionBaseKeyProperty As DependencyProperty =
            DependencyProperty.RegisterAttached("_FrameSessionBaseKey", GetType(String), GetType(SuspensionManager), Nothing)
        ...
        Public Shared Sub RegisterFrame(frame As Frame, sessionStateKey As String, Optional sessionBaseKey As String = Nothing)
            ...
            If sessionBaseKey IsNot Nothing Then
