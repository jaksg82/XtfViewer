...
Public NotInheritable Class MainPage
    ...
    Private Async Sub OpenButton_Click(sender As Object, e As RoutedEventArgs) Handles OpenButton.Click
        ...
        Else
            ...
            LoadResult = Await ind.LoadFromXtfFileAsync(LoadedFileToken)
            ...
            Else
                Dim msgbox As New Windows.UI.Popups.MessageDialog("Error on loading XTF file.")
                Dim cmdOK As New Windows.UI.Popups.UICommand("OK")
                msgbox.Commands.Add(cmdOK)
